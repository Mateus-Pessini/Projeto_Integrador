...
public class Feriados {
    public Calendar pascoa = Calendar.getInstance();
    public Calendar carnaval = Calendar.getInstance();
    public Calendar corpusChristi = Calendar.getInstance();
    public Calendar sextaFeiraSanta = Calendar.getInstance();
    public Calendar diaDoTrabalhador =  Calendar.getInstance();
    public Calendar natal =  Calendar.getInstance();
    public Calendar seteDeSetembro =  Calendar.getInstance();
    public Calendar diasDasCriancas =  Calendar.getInstance();
    public Calendar finados =  Calendar.getInstance();
    public Calendar proclamacaoDaRepublica =  Calendar.getInstance();
    public Calendar tiradentes = Calendar.getInstance();
    public Calendar primeiroDiaDoAno = Calendar.getInstance();
    ...
    public boolean isFeriado(Date date) {
        ...
        Calendar calendarAComparar = Calendar.getInstance();
